...
<style>
  ...
  <body>
    ...
    <form method="POST" action="${pageContext.request.contextPath}/booking" enctype="multipart/form-data">
      <div class="container">
        <div class="row justify-content-center mb-4 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Client profile for ${username}</h2>
          </div>
        </div>
        <div class="row justify-content-center mb-4 pb-5">
        ...
        <div class="row justify-content-center  ">
          <div class="col-md-7 text-center heading-section ftco-animate">
          	<h4>Review Score: </h4><h4 id="reviewScore"></h4>
         </div>
         </div>
      ...
      <div class="container">
		...
		<script>
			var jsAtt = '${propertyName}';
			document.getElementById("back").innerHTML += "<a href= ${pageContext.request.contextPath}/notifications> Back to my notifications </a>";
		</script>
...
String sql="select comment, score, owner_id from review_client where client_id = ?";
String sql2="select user, email, first_name, last_name from client where client_id = ?";
String sql3="select first_name, last_name from owner where owner_id = ?";
String sql4="select avg(score) as review_score from review_client where client_id = ?";
...
preparedStatement2.setInt(1, Integer.parseInt((String)request.getAttribute("clientid")));
preparedStatement.setInt(1, Integer.parseInt((String)request.getAttribute("clientid")));
preparedStatement4.setInt(1, Integer.parseInt((String)request.getAttribute("clientid")));
session.setAttribute("clientid", (String) request.getAttribute("clientid"));
resultSet2= preparedStatement2.executeQuery();
%> <% 
while(resultSet2.next()){
String user = resultSet2.getString(1);
String email = resultSet2.getString(2);
String fname = resultSet2.getString(3);
...
while(resultSet4.next()){
	float average = resultSet4.getFloat("review_score");
...
document.getElementById("reviewScore").innerHTML += jsAtt14;
</script>
...
while(resultSet.next()){
	...
	preparedStatement3.setInt(1, ownerId);
	resultSet3 = preparedStatement3.executeQuery();
	
	while(resultSet3.next()){
		String ownerfName = resultSet3.getString(1);
		String ownerlName = resultSet3.getString(2);
		session.setAttribute("ownerName", ownerfName + " " + ownerlName);
	}
	
	%>
	
	<script>
	var jsAtt11 = '${ownerName}';
	var jsAtt12 = '${comment}';
	var jsAtt13 = '${score}';
